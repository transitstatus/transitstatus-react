      ...
      <table>
        ...
        <tbody>
          <tr id="1-21-10">
            ...
            <td>
              <ul>
                <li>Added setting to maximize number of trains per destination at a stop.</li>
                <li>Added internal config option to better sort destinations if data is available.</li>
                <li>Changed CTA config to work with new data source.</li>
              </ul>
            </td>
          </tr>
           <tr id="1-21-9">
            ...
            <td>
              <ul>
                <li>RUTGERS IS BAAAAACCCCCKKKKKK.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-21-8">
            <td>
              <a href="#1-21-8">v1.21.8</a>
            </td>
            <td>
              <ul>
                <li>Updated map style and source data.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-21-7">
          ...
          <tr id="1-20-16">
            ...
            <td>
              <ul>
                <li>Changed "Sch." to "⏲" to indicate a scheduled trip.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-20-15">
            <td>
              <a href="#1-20-15">v1.20.15</a>
            </td>
            <td>
              <ul>
          ...
          <tr id="1-20-14">
            <td>
              <a href="#1-20-14">v1.20.14</a>
            </td>
            <td>
              <ul>
                <li>Fixed south shore line and swtiched to new endpoint.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-20-13">
          ...
          <tr id="1-20-12">
            ...
            <td>
              <ul>
                <li>Re-enabled UP Big Boy tracker.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-20-11">
          ...
          <tr id="1-20-5">
            ...
            <td>
              <ul>
                <li>Added CPKC holiday trains.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-20-4">
          ...
          <tr id="1-20-1">
            ...
            <td>
              <ul>
                <li>Changed candy cane out for spiral candy.</li>
                <li>Fixed south shore line.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-20-0">
          ...
          <tr id="1-17-2">
            ...
            <td>
              <ul>
                <li>Added alerts to API spec.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-17-1">
          ...
          <tr id="1-16-5">
            ...
            <td>
              <ul>
                <li>I remembered I have a registered trademark lol.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-16-4">
          ...
          <tr id="1-16-3">
            ...
            <td>
              <ul>
                <li>Updated API docs to reflect small schema change.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-16-2">
          ...
          <tr id="1-15-7">
            ...
            <td>
              <ul>
                <li>Added Dekalb, IL/Huskie Lines.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-15-6">
          ...
          <tr id="1-14-14">
            ...
            <td>
              <ul>
                <li>Proper support for inbound and outbound trains.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-14-13">
          ...
          <tr id="1-14-9">
            ...
            <td>
              <ul>
                <li>Added basic support for scheduled trains.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-14-8">
          ...
          <tr id="1-14-6">
            ...
            <td>
              <ul>
                <li>Re-enabled CTA holiday bus.</li>
              </ul>
            </td>
          </tr>
          <tr id="1-14-5">
